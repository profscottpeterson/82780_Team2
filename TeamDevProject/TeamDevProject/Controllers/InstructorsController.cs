...
namespace TeamDevProject.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public InstructorsController(TeamDevProjectContext context)
        {
            _context = context;
        }
        ...
        {
            var teamDevProjectContext = _context.Instructor.Include(i => i.Course);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstructorId,Fname,Lname,CourseId")] Instructor instructor)
        {
